...
```shell
curl -sLO https://binary.picodata.io/repository/raw/genin/bin/genin-0.4.21-x86_64-musl.tar.gz
tar -xvf genin-0.4.21-x86_64-musl.tar.gz ; sudo install genin /usr/local/bin/
```
...
```shell
sudo rpm -i https://binary.picodata.io/repository/yum/el/8/x86_64/os/genin-0.4.21-1.el8.x86_64.rpm
```
RHEL 7.x, CentOS 7.x
```shell
sudo rpm -i https://binary.picodata.io/repository/yum/el/7/x86_64/os/genin-0.4.21-1.el7.x86_64.rpm
```
...
```shell
curl -sLO https://binary.picodata.io/repository/raw/genin/deb/genin-0.4.21.amd64.deb && sudo dpkg -i genin-0.4.21.amd64.deb
```
...
homebrew:
```shell
curl -L https://binary.picodata.io/repository/raw/genin/apple/genin-0.4.21-darwin-amd64.zip -o genin-0.4.21-darwin-amd64.zip
unzip genin-0.4.21-darwin-amd64.zip -d ~/bin/
```
...
```shell
curl.exe -L https://binary.picodata.io/repository/raw/genin/windows/genin-0.4.21-darwin-amd64.zip -o genin-0.4.21-windows-amd64.zip
unzip.exe genin-0.4.21-windows-amd64.zip -d %HOME%/.cargo/bin/
```
