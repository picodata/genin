...
fn build_consistency_100_times() {
    let args = Command::new("genin")
        ...
        .try_get_matches_from(vec![
            "genin",
            "--source",
            "tests/resources/cluster-consistency.genin.yml",
        ])
        .unwrap();
...
//            "genin",
//            "--old",
//            "tests/resources/cluster.genin.yml",
//            "--new",
//            "tests/resources/cluster-new.genin.yml",
//        ])
//        .unwrap();
//
//    let upgrade_inventory = || -> String {
//        let old = Cluster::try_from("tests/resources/cluster.genin.yml").unwrap();
//        let new = Cluster::try_from("test")
//    };
//
//    let upgrade_inventory = || -> String {
//        let bytes = IO {
...
//                        })
//                        .and_then(|input_cluster| Cluster::merge(input_cluster, new))
//                })
//                .map(|upgraded| IO {
//                    input: Some(upgraded),
//                    output,
